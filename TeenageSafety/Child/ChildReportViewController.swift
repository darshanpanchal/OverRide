...
class ChildReportViewController: UIViewController {
    ...
    func getParentChildTripReportAPIRequest(childID:String,strDate:String){
        ...
        APIRequestClient.shared.sendRequest(requestType: .POST, queryString: kChildReport, parameter:childReportParameters as? [String:AnyObject], isHudeShow: true, success: { (responseSuccess) in
...
extension ChildReportViewController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
...
extension ChildReportViewController:UITableViewDelegate,UITableViewDataSource{
